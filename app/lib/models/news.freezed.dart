    ...
    return _then(_value.copyWith(
      ...
      publishedAt: freezed == publishedAt
          ...
          : publishedAt // ignore: cast_nullable_to_non_nullable
              as DateTime?,
      relatedSymbols: freezed == relatedSymbols
...
class _$NewsImpl implements _News {
  ...
  @override
  String toString() {
    return 'News(title: $title, description: $description, url: $url, source: $source, thumbnailUrl: $thumbnailUrl, publishedAt: $publishedAt, relatedSymbols: $relatedSymbols)';
  }
...
abstract class _News implements News {
  const factory _News(
      ...
      final String? thumbnailUrl,
      final DateTime? publishedAt,
      final List<String>? relatedSymbols}) = _$NewsImpl;
